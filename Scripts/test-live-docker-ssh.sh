...
XTEST_ONLY_ARGS=("-only-testing:GlassdeckAppTests/SSHConnectionManagerLiveDockerTests")
XTEST_ONLY_LABELS=("GlassdeckAppTests/SSHConnectionManagerLiveDockerTests")
parse_standard_args "$@"
...
run_sim_test test-live-docker-ssh GlassdeckAppUnit "$XCODE_TEST_DEFAULT_UNIT_SIM_DERIVED_DATA" \
